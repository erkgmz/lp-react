...
export default {
  ...
  target: 'web',
  output: {
    path: path.resolve(__dirname, 'dist/static/'), // Note: Physical files are only output by the production build task `npm run build`.
    publicPath: './',
  ...
  module: {
    loaders: [
      ...
      {test: /\.(pdf|jpe?g|png|gif)$/i, loader: 'file?name=[name].[ext]'},
